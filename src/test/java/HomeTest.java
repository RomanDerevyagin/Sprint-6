...
public class HomeTest extends BaseTest {
    ...
    @ParameterizedTest
    @MethodSource("FAQ")
    public void checkFAQ(int index, String expectedResult) {
        HomePage hp = new HomePage(driver);
        hp.clickCookie();
        hp.scrollToFaq();
        hp.clickQuestion(index);
        String text = hp.getAnswerText(index);
        assertEquals(expectedResult, text, "Не совпадает текст");
    }
